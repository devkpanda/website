...
<!--script-->
  ...
  <title>DevKpanda Serviços</title>
...
<body style="background-color: #ededed !important;">
  <div id="container" ;>
    <div class="bg-neutral-200 py-12">
      <div class="flex max-w-7xl mx-auto w-full">
        <div class="flex-1">
          <a class="btn btn-ghost normal-case text-xl font-medium"><img class="h-full" src="assets/images/logoenome.png"
              alt=""></a>
        </div>
        <div class="flex-none">
          <ul class="menu menu-horizontal px-1">
            <li><a class="text-black">Home</a></li>
            <li><a class="text-black">Contato</a></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="container justify-center mx-auto">
      ...
      <div class="btn-group grid grid-cols-4 w-50 justify-start ms-10">
        <button id="button1" class="btn btn-primary text-black">Front-end</button>
    ...
    <div class="bg-neutral w-full">
      <footer class="footer p-10 text-neutral-content mx-auto max-w-4xl">
        <div>
